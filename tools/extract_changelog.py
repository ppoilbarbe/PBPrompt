...
Usage
-----
    python tools/extract_changelog.py v1.0.1
    python tools/extract_changelog.py 1.0.1   # leading 'v' is optional
    python tools/extract_changelog.py v1.0.1 > RELEASE_NOTES.md
